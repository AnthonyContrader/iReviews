 ...
 */
@NgModule({
  declarations: [AdminDashboardComponent, UsersComponent, WorkInProgressComponent, UserDetailsComponent, TipologiaComponent, EsercizioComponent, LocalitaComponent, ReviewComponent],
  imports: [
    CommonModule,
    AdminRoutingModule,
    FormsModule
