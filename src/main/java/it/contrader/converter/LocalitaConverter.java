...
public class LocalitaConverter extends AbstractConverter<Localita, LocalitaDTO> {
	...
	public Localita toEntity(LocalitaDTO localitaDTO) {
		Localita localita = new Localita(localitaDTO.getId(), localitaDTO.getCitta(),localitaDTO.getProvincia(),localitaDTO.getStato());
		return localita;
	}

	@Override
	public LocalitaDTO toDTO(Localita localita) {
		LocalitaDTO localitaDTO = new LocalitaDTO(localita.getId(), localita.getCitta(),localita.getProvincia(),localita.getStato());
		return localitaDTO;
	}
